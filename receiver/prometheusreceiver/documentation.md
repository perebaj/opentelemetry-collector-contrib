...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `receiver.prometheusreceiver.EnableAppenderV2` | alpha | When enabled, uses the new Prometheus AppenderV2 interface for scraping metrics. AppenderV2 delivers metadata and exemplars inline with each sample, eliminating the PassMetadataInContext hack and simplifying the translation pipeline. | v0.147.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45597) |
